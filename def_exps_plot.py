...
euler_01 = experiment(name='atm_rte_rrtmgp_amip_test_e6_gcc02',
                      label='Euler6, gcc.02',
                      bestconf=35,
                      marker='>',
                      color='#fcae91',
...
euler_02 = experiment(name='atm_rte_rrtmgp_amip_test_gcc02',
                      label='gcc.02',
                      bestconf=35,
                      marker='x',
                      color='#fb6a4a',
...
daint_01 = experiment(name='atm_rte_rrtmgp_amip_test_gcc02',
                      label='gcc.02',
                      bestconf=35,
                      marker='>',
                      color='#fcae92',
...
daint_02 = experiment(name='atm_rte_rrtmgp_amip_test_pgi02',
                      label='pgi.02',
                      bestconf=35,
                      marker='x',
                      color='#fb6a4a',
