...
iconham_gcc = experiment(name = 'atm_amip_hammoz_marc', label = 'ICON-HAM', bestconf = 24, marker = '+') #, color = 'LightBlue', marker = 'd', linestyle = '-')

icon_amip_6h_gcc = experiment(name = 'atm_amip_gcc_6h', label = 'ICON GCC 6h', bestconf = 24, marker = '.', color = 'LightBlue')#, marker = 'd', linestyle = '-')
...
icon_amip_6h_intel = experiment(name = 'atm_amip_intel_6h', label = 'ICON intel 6h', bestconf = 64, marker = '.', color = 'Red')#, marker = 'd', linestyle = '-')
...
icon_amip_6h_cray = experiment(name = 'atm_amip_6h', label = 'ICON cray 6h', bestconf = 24, marker = '.', color = 'Green')#, marker = 'c', linestyle = '-')
